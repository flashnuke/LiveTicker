...
# (str) Package name
package.name = livetickergame

# (str) Package domain (needed for android/ios packaging)
package.domain = org.liveticker
...
presplash.filename = %(source.dir)s/icons/presplash_logo.png

# (str) Icon of the application
icon.filename = %(source.dir)s/icons/main_logo.png
